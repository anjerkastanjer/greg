                    ...
                    @if ($oppasser)
                        ...
                        <div class="text-center mb-6">
                            ...
                            @if ($oppasser->profile_image)
                                <img src="{{ asset('storage/' . $oppasser->profile_image) }}" alt="Image of {{ $oppasser->naam }}" class="max-w-xs max-h-20 w-full h-auto rounded-full mx-auto mb-4 object-contain">
                            @else
