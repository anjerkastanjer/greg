        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if ($oppasser)
                        <!-- Display if the user is already a pet sitter -->
                        ...
                        <!-- Optional delete button for this pet sitter -->
                    ...
                    <ul class="mt-4">
                        @foreach ($oppassers as $oppasser)
                            @if (auth()->check() && ($oppasser->user_id !== auth()->id())) <!-- Skip the current user's oppasser -->
                                <li class="mb-4 border-b-2 border-gray-300 pb-4">
                                    <strong>Naam:</strong> {{ $oppasser->naam }} <br>
