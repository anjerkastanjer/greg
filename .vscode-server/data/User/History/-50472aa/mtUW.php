            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if ($oppasser)
                        ...
                        <img src="{{ asset('storage/' . $oppasser->profile_image) }}" alt="Image of {{ $oppasser->naam }}" class="rounded-full w-80 h-80 mx-auto mb-4 object-scale-down" style= "max-height: 150px;">
                        </div>
                                ...
                                @if (auth()->check() && ($oppasser->user_id !== auth()->id())) <!-- Skip the current user's oppasser -->
                                    <li class="mb-4 border-t border-white pt-4">
                                        ...
                                        @if ($oppasser->profile_image)
                                            ...
                                            <img src="{{ asset('storage/' . $oppasser->profile_image) }}" alt="Image of {{ $oppasser->naam }}" class="rounded-full mx-auto mb-4" style= "max-height: 300px; max-width: 100%; width: 100%; height: auto;">
