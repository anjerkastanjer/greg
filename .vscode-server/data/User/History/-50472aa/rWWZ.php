                    ...
                    @if ($oppasser)
                        ...
                        <div class="text-center mb-6">
                            ...
                            @if ($oppasser->profile_image)
                                <img src="{{ asset('storage/' . $oppasser->profile_image) }}" alt="Image of {{ $oppasser->naam }}" class="rounded-full mx-auto mb-4 max-w-[300px] max-h-[300px] w-[300px] h-[300px] object-cover">
                            @else
