            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="text-center"> <!-- Center the content -->
                        <h1 class="text-2xl font-bold">Welkom op mijn pagina!</h1>
                        <p class="mt-2">{{ __("Ik ben blij dat je je hebt aangemeld. Op deze pagina kun je je aanmelden als oppasser.") }}</p>
                    </div>

                    @if ($oppasser)
                        <p class="mt-4">Je hebt je succesvol aangemeld als oppasser. Hier zijn je gegevens:</p>
                    ...
                    @else
                        <div class="flex justify-center mt-6"> <!-- Center the button -->
                            <button id="toggle-oppasser-form" class="inline-flex items-center justify-center px-4 py-2 border border-black rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                Oppasser Aanmelden
                            </button>
                        </div>
