...
Route::get('/geaccepteerde-aanvragen', [AanvraagController::class, 'geaccepteerdPagina'])->name('aanvragen.geaccepteerd');


// geaccepteerde aanvragen routes
// mijn diensten pagina routes
Route::get('/mijn-diensten', [AanvraagController::class, 'geaccepteerd'])->name('aanvragen.geaccepteerd');
Route::get('/geaccepteerde-aanvragen', [AanvraagController::class, 'geaccepteerde-Aanvragen'])->name('aanvragen.geaccepteerd');
